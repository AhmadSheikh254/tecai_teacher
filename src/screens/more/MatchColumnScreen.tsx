            ...
            <TouchableOpacity style={styles.genBtnWrap} onPress={handleGenerate} activeOpacity={0.85}>
              ...
              >
                ...
                <View style={{ flex: 1, justifyContent: 'center' }}>
                  <Text style={styles.genBtnText} numberOfLines={1}>Generate Match the Column</Text>
                  <Text style={styles.genBtnSub} numberOfLines={1}>AI · Column Shuffling · Answer Key</Text>
                </View>
                <LinearGradient
...
const styles = StyleSheet.create({
  ...
  pill: {
    ...
    borderWidth: 1, borderColor: '#D9CBB6',
  },
  pillText: { fontSize: 9.5, fontWeight: '800', color: '#63574A' },

  card: {
    backgroundColor: '#FFFFFF', borderRadius: 14, padding: 12,
    borderWidth: 1, borderColor: '#D9CBB6',
    shadowColor: '#63574A', shadowOffset: { width: 0, height: 4 },
  ...
  fieldDot: { width: 4, height: 4, borderRadius: 2, backgroundColor: '#B59A7A', marginRight: 6 },
  fieldLabel: { fontSize: 9.5, fontWeight: '900', color: '#4A3E3D', textTransform: 'uppercase', letterSpacing: 0.8 },

  textArea: {
    backgroundColor: '#FAF9F6', borderWidth: 1, borderColor: '#E6DFD5',
    borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8,
    fontSize: 12, color: '#1A1510', fontWeight: '600', height: 60, marginBottom: 10,
  },

  fileBox: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#FAF9F6',
    borderWidth: 1, borderStyle: 'dashed', borderColor: '#D9CBB6',
  ...
  fileText: { fontSize: 11.5, fontWeight: '600', color: '#63574A', flex: 1 },
  fileTextActive: { color: '#B59A7A', fontWeight: '700' },

  genBtnWrap: {
    borderRadius: 12, shadowColor: '#3E352B',
