    ...
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.pillRow}>
          {['📊 Gradebook Sheets', '📐 Auto Calculations', '⬇️ Download Excel', '📋 Copy Data'].map((t, i) => (
          ...
          {!generating ? (
            <TouchableOpacity style={styles.genBtnWrap} onPress={handleGenerate} activeOpacity={0.85}>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.genBtnText}>Generate Excel File</Text>
                  <Text style={styles.genBtnSub}>AI · Calculations · Sheet Schema</Text>
                </View>
                <LinearGradient
...
const styles = StyleSheet.create({
  ...
  pillText: { fontSize: 11.5, fontWeight: '800', color: '#1a5c38' },

  card: {
    backgroundColor: '#FFFFFF', borderRadius: 28, padding: 22,
    borderWidth: 1.5, borderColor: '#A7F3D0',
    shadowColor: '#217346', shadowOffset: { width: 0, height: 12 },
  ...
  fieldDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#217346', marginRight: 8 },
  fieldLabel: { fontSize: 12, fontWeight: '900', color: '#103822', textTransform: 'uppercase', letterSpacing: 0.9 },

  textArea: {
    backgroundColor: '#FAFDFB', borderWidth: 1.5, borderColor: '#D1F5E9',
    borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14,
    fontSize: 14.5, color: '#0A2516', fontWeight: '600', height: 110, marginBottom: 16,
  },

  fileBox: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#FAFDFB',
    borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#A7F3D0',
  ...
  fileText: { fontSize: 14, fontWeight: '600', color: '#1a5c38', flex: 1 },
  fileTextActive: { color: '#217346', fontWeight: '700' },

  genBtnWrap: {
    borderRadius: 18, shadowColor: '#1a5c38',
  ...
  generatingState: {
    flexDirection: 'row', backgroundColor: '#E6F4EA', borderRadius: 16, height: 56,
    alignItems: 'center', justifyContent: 'center',
    borderWidth: 1.5, borderColor: '#217346',
  },
  generatingStateText: { fontSize: 14.5, fontWeight: '800', color: '#217346' },
