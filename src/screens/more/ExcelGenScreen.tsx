...
const styles = StyleSheet.create({
  ...
  pillText: { fontSize: 9.5, fontWeight: '800', color: '#1a5c38' },

  card: {
    backgroundColor: '#FFFFFF', borderRadius: 14, padding: 12,
    borderWidth: 1, borderColor: '#A7F3D0',
    shadowColor: '#217346', shadowOffset: { width: 0, height: 4 },
  ...
  fieldLabel: { fontSize: 9.5, fontWeight: '900', color: '#103822', textTransform: 'uppercase', letterSpacing: 0.8 },

  textArea: {
    backgroundColor: '#FAFDFB', borderWidth: 1, borderColor: '#D1F5E9',
    borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8,
    fontSize: 12, color: '#0A2516', fontWeight: '600', height: 60, marginBottom: 10,
  },
  ...
  genBtnWrap: {
    borderRadius: 12, shadowColor: '#1a5c38',
