          ...
          {!generating ? (
            <TouchableOpacity style={styles.genBtnWrap} onPress={handleGenerate} activeOpacity={0.85}>
              ...
              >
                ...
                <View style={{ flex: 1 }}>
                  <Text style={styles.genBtnText}>Generate Q&A Sets</Text>
                  <Text style={styles.genBtnSub}>AI · Study Cards · Key prep</Text>
                </View>
                <LinearGradient
...
const styles = StyleSheet.create({
  ...
  pillText: { fontSize: 11.5, fontWeight: '800', color: '#5B21B6' },
  ...
  fieldDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#8B5CF6', marginRight: 8 },
  fieldLabel: { fontSize: 12, fontWeight: '900', color: '#2E1065', textTransform: 'uppercase', letterSpacing: 0.9 },

  textArea: {
    backgroundColor: '#FAF9FF', borderWidth: 1.5, borderColor: '#E9E3FF',
    borderRadius: 14, paddingHorizontal: 16, paddingVertical: 14,
    fontSize: 14.5, color: '#1E0A3B', fontWeight: '600', height: 110, marginBottom: 16,
  },

  fileBox: {
    flexDirection: 'row', alignItems: 'center', backgroundColor: '#FAF9FF',
    borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#DDD6FE',
  ...
  fileText: { fontSize: 14, fontWeight: '600', color: '#5B21B6', flex: 1 },
  fileTextActive: { color: '#8B5CF6', fontWeight: '700' },

  genBtnWrap: {
    borderRadius: 18, shadowColor: '#5B21B6',
