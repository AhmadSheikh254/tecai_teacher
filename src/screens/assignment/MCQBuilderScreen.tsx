...
const S = StyleSheet.create({
  ...
  // Hero Banner
  heroBanner: { borderRadius: 24, overflow: 'hidden', marginBottom: 16, shadowColor: '#10B981', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.18, shadowRadius: 18, elevation: 8 },
  heroGrad: { padding: 24, minHeight: 168 },
  heroIconBox: { width: 60, height: 60, borderRadius: 18, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: 'rgba(16,185,129,0.2)', shadowColor: '#10B981', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 4 },
  heroTag: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 7, paddingHorizontal: 13, borderRadius: 20, borderWidth: 1.2, borderColor: 'rgba(16,185,129,0.25)' },
  heroTagDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#10B981' },
  heroTagText: { fontSize: 12, fontWeight: '900', color: '#059669', letterSpacing: 0.6 },
  heroTitle: { fontSize: 28, fontWeight: '900', color: '#064E3B', letterSpacing: -0.5, marginBottom: 5 },
  heroSub: { fontSize: 15, fontWeight: '600', color: '#065F46', opacity: 0.8 },
  activeChip: { flexDirection: 'row', alignItems: 'center', gap: 7, paddingVertical: 7, paddingHorizontal: 14, borderRadius: 20, borderWidth: 1.2, borderColor: 'rgba(16,185,129,0.25)' },
  activeDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#10B981' },
  activeText: { fontSize: 14, fontWeight: '800', color: '#047857' },
  ...
  cardSub: { fontSize: 14, color: '#64748B', fontWeight: '600', marginTop: 2 },

  // Form
  formRow: { flexDirection: 'row', marginBottom: 14 },
  label: { fontSize: 15, fontWeight: '800', color: '#374151', marginBottom: 8, letterSpacing: 0.2 },
  inputWrap: { flexDirection: 'row', alignItems: 'center', borderWidth: 1.5, borderColor: '#E2E8F0', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 12, backgroundColor: '#F8FAFC', marginBottom: 14 },
  input: { flex: 1, fontSize: 15, fontWeight: '700', color: '#0F172A', padding: 0, ...Platform.select({ web: { outlineStyle: 'none' } as any }) },
  dropdownContainer: {
    backgroundColor: '#ffffff',
    borderRadius: 14,
    borderWidth: 1.5,
