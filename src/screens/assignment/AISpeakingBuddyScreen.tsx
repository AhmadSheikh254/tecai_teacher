...
const styles = StyleSheet.create({
  ...
  // Luxury Hero Card
  heroCard: {
    margin: 14, borderRadius: 24, padding: 22, overflow: 'hidden',
    position: 'relative',
    shadowColor: '#003d9b', shadowOffset: { width: 0, height: 8 },
  ...
  luxuryHeroTitle: {
    fontSize: 28, fontWeight: '900', color: '#0A1F5C',
    letterSpacing: 0.5, marginTop: 10,
  },
  luxuryHeroSub: {
    fontSize: 11.5, fontWeight: '700', color: '#334155',
    lineHeight: 16, marginTop: 4, opacity: 0.95,
  },
  ...
  statsGlassPanel: {
    ...
    borderWidth: 1.5, borderColor: 'rgba(0, 82, 204, 0.12)',
    marginTop: 18,
  },
  statGlassCell: { flex: 1, alignItems: 'center' },
  statGlassNum:  { fontSize: 19, fontWeight: '900', color: '#0A1F5C' },
  statGlassLabel:{ fontSize: 8, fontWeight: '900', color: '#475569', marginTop: 2, letterSpacing: 0.5 },
  statGlassSep:  { width: 1, height: 22, backgroundColor: 'rgba(0, 82, 204, 0.15)' },
  ...
  searchInput:   { flex: 1, height: 44, fontSize: 14, fontWeight: '600', color: '#0F172A' },

  // List header
  listHeader: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    paddingHorizontal: 14, marginTop: 8, marginBottom: 10,
  },
  listTitle:  { fontSize: 16, fontWeight: '900', color: '#0A1F5C' },
  countBadge: { backgroundColor: '#EEF2FF', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4 },
  countText:  { fontSize: 11, fontWeight: '800', color: '#003d9b' },

  // Empty
  emptyBox:  { alignItems: 'center', paddingVertical: 50 },
  emptyTitle:{ fontSize: 15, fontWeight: '900', color: '#94A3B8', marginTop: 12 },
  emptyDesc: { fontSize: 12, fontWeight: '600', color: '#CBD5E1', marginTop: 4 },
  ...
  cardAccent: { width: 6, backgroundColor: '#003d9b' },
  cardWaveSvg: { position: 'absolute', bottom: 44, left: 0, right: 0 },
  cardInteriorGlow: { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 },
  cardBody:   { flex: 1, padding: 18, position: 'relative' },

  cardTopRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 16, gap: 10, justifyContent: 'space-between' },
  ...
  micIconGrad: { width: '100%', height: '100%', borderRadius: 21, alignItems: 'center', justifyContent: 'center' },
  cardTopicTitle: { fontSize: 16.5, fontWeight: '900', color: '#0A1F5C' },
  activeStatusTagRow: { flexDirection: 'row', alignItems: 'center', marginTop: 3 },
  activePulseDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#10B981', marginRight: 6 },
  voiceLogLabel: { fontSize: 10, color: '#64748B', fontWeight: '800' },

  // Equalizer visualizer
  waveformContainer: { flexDirection: 'row', alignItems: 'flex-end', height: 34, gap: 3.5 },
  wavePillar: { width: 4, borderRadius: 2 },

  fieldsRow:  { flexDirection: 'row', alignItems: 'center', marginBottom: 16 },
  fieldChip: {
    flex: 1, flexDirection: 'row', alignItems: 'center',
    borderRadius: 14, padding: 11,
    borderWidth: 1.2, borderColor: 'rgba(226, 232, 240, 0.9)',
    borderLeftWidth: 4,
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.02, shadowRadius: 2,
  },
  chipIndicatorOrb: { width: 24, height: 24, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  fieldChipLabel: { fontSize: 9, fontWeight: '900', color: '#94A3B8', letterSpacing: 0.5 },
  fieldChipValue: { fontSize: 13.5, fontWeight: '900', color: '#0A1F5C', marginTop: 1 },
  fieldSep:       { width: 8 },
  ...
  btnPreview: {
    ...
    overflow: 'hidden',
    shadowColor: '#003d9b', shadowOffset: { width: 0, height: 3 },
